...
def protected_secret(password, secret, num_attempts):
    ...
    """
    cnt = 0
    def get_secret(password_attempt, attempts):
        if attempts < num_attempts and password_attempt == password:
            print(secret)
            ...
            attempts += 1
        return partial(get_secret, attempts=attempts)
    
    return partial(get_secret, attempts=0)
